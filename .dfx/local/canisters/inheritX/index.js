...
import { idlFactory } from './inheritX.did.js';
export { idlFactory } from './inheritX.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.INHERITX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./inheritX.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the inheritX canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./inheritX.did.js")._SERVICE>}
 */
export const inheritX = createActor(canisterId);
